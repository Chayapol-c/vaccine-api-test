...
class RegistrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        citizen_id = self.param.get("citizen_id")
    ...
    def test_post_registration(self):
        ...
        response = requests.post(self.endpoint, params=self.param)
    ...
    def test_post_with_more_than_13_digits_id(self):
        ...
        self.param["citizen_id"] = "1234567890123123123"
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(200, response.status_code)
        self.assertIn("failed", response.text)
        self.assertEqual("application/json", response.headers["content-type"])
    ...
    def test_post_with_d_m_y_birth_date(self):
        ...
        self.param["birth_date"] = datetime(2000, 11, 5).strftime("%d/%m/%Y")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(201, response.status_code)
        self.assertIn("success", response.text)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
    ...
    def test_post_with_y_m_d_birth_date(self):
        ...
        self.param["birth_date"] = datetime(2000, 11, 5).strftime("%Y/%m/%d")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(201, response.status_code)
        self.assertIn("success", response.text)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
    ...
    def test_post_with_m_d_y_birth_date(self):
        ...
        self.param["birth_date"] = datetime(2000, 11, 5).strftime("%m/%d/%Y")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(201, response.status_code)
        self.assertIn("success", response.text)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
    ...
    def test_post_with_m_y_d_birth_date(self):
        ...
        self.param["birth_date"] = datetime(2000, 11, 5).strftime("%m/%Y/%d")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(200, response.status_code)
        self.assertIn("failed", response.text)
        self.assertEqual("application/json", response.headers["content-type"])
    ...
    def test_post_with_d_y_m_birth_date(self):
        ...
        self.param["birth_date"] = datetime(2000, 11, 5).strftime("%d/%Y/%m")
        response = requests.post(self.endpoint, params=self.param)
        content = response.json()
        self.assertIn("failed", response.text)
        self.assertEqual(200, response.status_code)
    ...
    def test_post_with_less_than_12_years_old(self):
        ...
        self.param["birth_date"] = less_than_12_year_old.strftime("%d/%m/%Y")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(200, response.status_code)
        self.assertIn("failed", response.text)
        self.assertEqual("application/json", response.headers["content-type"])
    ...
    def test_post_with_future_date(self):
        ...
        self.param["birth_date"] = future_date.strftime("%d/%m/%Y")
        response = requests.post(self.endpoint, params=self.param)
        self.assertEqual(200, response.status_code)
        self.assertIn("failed", response.text)
        self.assertEqual("application/json", response.headers["content-type"])
    ...
    def test_remove_invalid_registration(self):
        ...
        citizen_id = self.param.get("citizen_id")
        response = requests.delete(f"{self.endpoint}/{citizen_id}", params=self.param)
        self.assertEqual(404, response.status_code)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
        self.assertIn("Redirecting...", response.text)
    ...
    def test_remove_registration(self):
        ...
        self.assertEqual(200, response.status_code)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
        self.assertNotIn(citizen_id, response.text)

    def test_get_registration(self):
        """Send the GET request to retrive a registration."""
        citizen_id = self.param.get("citizen_id")
        response = requests.post(self.endpoint, params=self.param)
        response = requests.get(f"{self.endpoint}/{citizen_id}", params=self.param)
        self.assertEqual(200, response.status_code)
        content = response.json()
        self.param.update({"vaccine_taken": "[]"})
        self.assertEqual(self.param, content)
        self.assertEqual("text/html; charset=utf-8", response.headers["content-type"])
